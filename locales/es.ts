export default {
 ...
 workout_builder: {
   ...
   goal_select: "Objetivo de entrenamiento",
  goal_strength: "Fuerza",
  goal_hypertrophy: "Hipertrofia",
  goal_endurance: "Resistencia",
  goal_general: "General",
  days_select: "Días por semana",
  split_preview: "Tu split semanal",
  split_hint: "Los números muestran las series objetivo por músculo. x2 significa entrenado dos veces por semana.",
  split_fullbody_1: "Cuerpo completo A",
  split_fullbody_2: "Cuerpo completo B",
  split_ppl_1: "Empuje",
  split_ppl_2: "Tracción",
  split_ppl_3: "Piernas",
  split_upperlower_1: "Parte superior A",
  split_upperlower_2: "Parte inferior A",
  split_upperlower_3: "Parte superior B",
  split_upperlower_4: "Parte inferior B",
  "split_ppl-ul_1": "Empuje",
  "split_ppl-ul_2": "Tracción",
  "split_ppl-ul_3": "Piernas",
  "split_ppl-ul_4": "Superior",
  "split_ppl-ul_5": "Inferior + Core",
  split_upper: "Superior",
  split_lower_core: "Inferior + Core",
  goal_split: {
    selection_hint: "Toca un día para cargar sus músculos. Puedes ajustarlos en el siguiente paso.",
  },
  plan_page: {
    create_title: "Crea tu plan de entrenamiento",
    create_subtitle: "Define tu objetivo y frecuencia. Generaremos una rutina basada en la ciencia.",
    sign_in_prompt_suffix: "para guardar tu plan y seguir el progreso.",
    save_error_auth: "Inicia sesión para guardar tu plan.",
    save_error_generic: "Algo salió mal. Inténtalo de nuevo.",
    edit_title: "Editar tu plan",
    preserve_progress: "Tu progreso ({sessions} sesiones) se conservará.",
    my_plan_title: "Mi plan de entrenamiento",
    progress_title: "Progreso",
    progress_sessions: "{count} sesiones completadas",
    next_recommended: "Siguiente recomendado: Día {day} · Ciclo {cycle}",
    weekly_split_title: "Split semanal",
    days_per_week: "{days} días / semana",
    next_up: "Siguiente",
    save_plan: "Guardar plan",
    save_changes: "Guardar cambios",
    train_button: "Entrenar",
  },
    quick: {
      title: "Entrenamiento rápido",
      subtitle: "Un circuito corto de peso corporal que evita los músculos del día.",
    time_label: "¿Cuánto tiempo tienes?",
    hint: "Ideal para un descanso activo en el trabajo o en días de descanso.",
    generate: "Generar entrenamiento rápido",
    generate_with_duration: "Generar entrenamiento rápido ({duration} min)",
    generating: "Generando...",
    time_option_label: "{minutes} min",
  },
  plan_session: {
    title: "Sesión de plan rápida",
    subtitle: "Genera el entrenamiento completo de hoy con un clic y avanza tu plan",
    today_title: "Hoy: día {day}",
    reason_no_recent_training: "Sin historial reciente de entrenamiento. Empieza desde el Día 1.",
    reason_cycle_reset: "Ciclo completado. Inicia el siguiente ciclo en el Día {day} ({restDays}d desde la última sesión).",
    reason_continue: "Última sesión fue el Día {lastDay} (hace {restDays}d). Continúa con el Día {nextDay}.",
    target_duration: "Duración objetivo: {duration} min",
    duration_badge: "Duración sugerida: {duration} min",
    duration_range: "Rango recomendado: {min}-{max} min",
    hint: "Selecciona tu equipo abajo y genera al instante.",
      generate: "Comenzar entrenamiento de hoy",
      generate_with_duration: "Comenzar entrenamiento de hoy ({duration} min)",
      start_today_with_duration: "Comenzar entrenamiento de hoy ({duration} min)",
      configure_equipment: "Selecciona el equipo primero",
      requires_equipment: "Selecciona al menos un equipo (o activa el modo solo peso corporal) antes de generar.",
      manage_plan: "Gestionar plan y progreso",
      generating: "Generando...",
    },
    stepper_bodyweight_mode_notice: "El modo de solo peso corporal está activo. BODY_ONLY se aplica automáticamente; ajústalo en preferencias si hace falta.",
    stepper_bodyweight_preference_notice: "La preferencia de peso corporal está activa y se ha aplicado BODY_ONLY.",
    stepper_split_day_hint: "Se han cargado los músculos del día {day} desde tu split. Ajústalo si es necesario.",
    steps: {
      equipment: {
        title: "Equipo",
    ...
    exercise: {
      ...
      image_alt: "Imagen del ejercicio",
      description_title: "Descripción",
      equipment_title: "Equipo",
      types_title: "Tipos de ejercicio",
      shuffle: "Mezclar",
      pick: "Elegir",
      remove: "Eliminar",
      cancel: "Cancelar",
      confirm_pick: "Confirmar selección",
    ...
    add_with_name: "Añadir {name}",
    exerciseAdded: "{name} añadido al entrenamiento",
    add_exercise_mascot_alt: "Mascota de entrenamiento",
    exercises: "ejercicios",
    equipment: {
      bodyweight: {
        label: "Peso corporal",
    ...
    session: {
     ...
     finish_session: "Terminar sesión",
      ...
      error_delete_session: "Error al eliminar la sesión. Inténtalo de nuevo.",
      error_shuffling_exercise: "Error al mezclar el ejercicio. Inténtalo de nuevo.",
      error_picking_exercise: "Error al seleccionar el ejercicio. Inténtalo de nuevo.",
      ...
      prescription_card_title: "Configuración de la sesión",
      prescription_rest_label: "Intervalo de descanso",
      prescription_rest_value: "{seconds}s",
      prescription_warmup_label: "Calentamiento",
      prescription_warmup_value: "{sets} x {reps} repeticiones",
      prescription_cooldown_label: "Enfriamiento",
      prescription_cooldown_value: "{sets} x {seconds}s de sostén",
      prescription_feature_disabled: "No incluido",
      stretch_reps: "rep. por lado",
      stretch_hold: "segundos por lado",
      exercise_completed: "Ejercicio completado",
      exercise_pending: "Próximo ejercicio",
      toggle_complete: "Alternar completado",
      delete_set: "Eliminar serie",
      time_unit_min: "min",
      time_unit_seconds: "s",
     bodyweight: "Peso corporal",
      ...
      target_duration_label: "Duración recomendada",
      remaining_time: "Restante: {time}",
      target_time_exceeded: "Excedido por {time}",
      ...
      exercise_image_alt: "Imagen del ejercicio",

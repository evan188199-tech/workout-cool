export default {
 ...
 workout_builder: {
  ...
  goal_general: "综合",
  days_select: "每周训练天数",
  split_preview: "每周训练分配",
  split_hint: "数字表示每个肌群的目标组数。x2表示每周训练两次。",
  split_fullbody_1: "全身训练A",
  split_fullbody_2: "全身训练B",
  split_ppl_1: "推",
  split_ppl_2: "拉",
  split_ppl_3: "腿部",
  split_upperlower_1: "上肢A",
  split_upperlower_2: "下肢A",
  split_upperlower_3: "上肢B",
  split_upperlower_4: "下肢B",
  "split_ppl-ul_1": "推",
  "split_ppl-ul_2": "拉",
  "split_ppl-ul_3": "腿",
  "split_ppl-ul_4": "上肢",
  "split_ppl-ul_5": "下肢 + 核心",
  split_upper: "上肢",
  split_lower_core: "下肢 + 核心",
  goal_split: {
    selection_hint: "点击某一天来加载对应肌群，你可以在下一步微调。",
  },
  plan_page: {
    create_title: "创建训练计划",
    create_subtitle: "设置你的目标与频率，我们将基于训练科学生成分化计划。",
    sign_in_prompt_suffix: "以保存计划并追踪进度。",
    save_error_auth: "请先登录后保存计划。",
    save_error_generic: "操作出现问题，请重试。",
    edit_title: "修改计划",
    preserve_progress: "你的进度（{sessions} 次训练）将被保留。",
    my_plan_title: "我的训练计划",
    progress_title: "进度",
    progress_sessions: "已完成 {count} 次训练",
    next_recommended: "下次建议：第 {day} 天 · 第 {cycle} 轮",
    weekly_split_title: "每周训练分配",
    days_per_week: "每周 {days} 天",
    next_up: "下一步",
    save_plan: "保存计划",
    save_changes: "保存修改",
    train_button: "开始训练",
  ...
  quick: {
    ...
    hint: "适合工位间隙或休息日来一组。",
    generate: "生成摸鱼训练",
    generate_with_duration: "生成摸鱼训练（{duration} 分钟）",
    generating: "生成中...",
    time_option_label: "{minutes} 分钟",
  },
   weekly_adjustment: {
     title: "下周计划建议",
     apply: "应用",
  ...
  plan_session: {
    ...
    today_title: "今日: 第 {day} 天",
    reason_no_recent_training: "暂无近期训练记录，今天从第1天开始。",
    reason_cycle_reset: "当前周期已完成，下一周期从第 {day} 天开始（距上次训练 {restDays} 天）。",
    reason_continue: "上次训练是第 {lastDay} 天（{restDays} 天前），继续到第 {nextDay} 天。",
    target_duration: "目标时长：{duration} 分钟",
    duration_badge: "建议时长：{duration} 分钟",
    duration_range: "建议范围：{min}-{max} 分钟",
    hint: "先在下方选好器械，然后一键生成。",
    generate: "开始今日训练",
    generate_with_duration: "开始今日训练（{duration} 分钟）",
    start_today_with_duration: "开始今日训练（{duration} 分钟）",
    configure_equipment: "先选择器械再生成",
    requires_equipment: "请先选择至少一件器械（或开启纯自重模式）后再生成。",
    manage_plan: "管理计划与进度",
    generating: "生成中...",
  },
  stepper_bodyweight_mode_notice: "已开启纯自重模式，BODY_ONLY 已自动作为器械约束。可在偏好设置里调整。",
  stepper_bodyweight_preference_notice: "已开启“纯自重”偏好，系统已自动按 BODY_ONLY 匹配器械。",
  stepper_split_day_hint: "已载入第 {day} 天训练肌群，按需调整。",
   steps: {
      equipment: {
        title: "设备",
        description: "选择您的设备",
    ...
    addExercise: "添加练习",
    add_with_name: "添加 {name}",
    exerciseAdded: "{name} 已添加到锻炼",
    add_exercise_mascot_alt: "训练吉祥物",
    exercises: "练习",
    equipment: {
      bodyweight: {
        label: "自重",
    ...
    session: {
     ...
     finish_session: "完成回合",
      rest_label: "休息",
      rest_countdown: "{seconds} 秒",
      skip_rest: "跳过休息",
      error_delete_session: "删除训练会话失败，请重试。",
      error_shuffling_exercise: "更换动作失败，请重试。",
      error_picking_exercise: "选择动作失败，请重试。",
      warmup_title: "热身拉伸",
      warmup_subtitle: "训练前进行动态拉伸,激活目标肌群、提高关节活动度。点击标记完成。",
      cooldown_title: "放松拉伸",
      cooldown_subtitle: "训练后进行静态拉伸,放松肌肉、促进恢复。每侧保持标注的时长。",
      prescription_card_title: "训练参数预览",
      prescription_rest_label: "组间休息",
      prescription_rest_value: "{seconds} 秒",
      prescription_warmup_label: "热身",
      prescription_warmup_value: "{sets}组 x {reps}次",
      prescription_cooldown_label: "放松",
      prescription_cooldown_value: "{sets}组 x {seconds}秒保持",
      prescription_feature_disabled: "未启用",
      stretch_reps: "次 / 每侧",
      stretch_hold: "秒 / 每侧",
      exercise_completed: "已完成",
      exercise_pending: "待完成",
     ...
     bodyweight: "自重",
      ...
      started_at: "开始于",
      target_duration_label: "建议时长",
      remaining_time: "剩余：{time}",
      target_time_exceeded: "超出目标 {time}",
      quit_workout: "退出锻炼",
      elapsed_time: "已用时间",
      chronometer: "计时器",
      exercise_progress: "练习进度",
      total_volume: "总训练量",
      exercise_image_alt: "练习图片",

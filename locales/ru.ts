export default {
 ...
 workout_builder: {
    ...
    goal_select: "Цель тренировки",
    goal_strength: "Сила",
    goal_hypertrophy: "Гипертрофия",
    goal_endurance: "Выносливость",
    goal_general: "Общее",
    days_select: "Дней в неделю",
    split_preview: "Ваше недельное разделение",
    split_hint: "Числа показывают целевые подходы по мышце. x2 означает тренировку дважды в неделю.",
    split_fullbody_1: "Всё тело A",
    split_fullbody_2: "Всё тело B",
    split_ppl_1: "Тяга/Толчок",
    split_ppl_2: "Тяга",
    split_ppl_3: "Ноги",
    split_upperlower_1: "Верх A",
    split_upperlower_2: "Низ A",
    split_upperlower_3: "Верх B",
    split_upperlower_4: "Низ B",
    "split_ppl-ul_1": "Толкающие",
    "split_ppl-ul_2": "Тянущие",
    "split_ppl-ul_3": "Ноги",
    "split_ppl-ul_4": "Верх",
    "split_ppl-ul_5": "Низ + Кор",
    split_upper: "Верх",
    split_lower_core: "Низ + Кор",
    goal_split: {
      selection_hint: "Нажмите на день, чтобы загрузить его мышцы. Вы можете скорректировать их на следующем шаге.",
    },
    plan_page: {
      create_title: "Создать тренировочный план",
      create_subtitle: "Выберите цель и расписание. Мы сгенерируем научно обоснованный сплит.",
      sign_in_prompt_suffix: "чтобы сохранить план и отслеживать прогресс.",
      save_error_auth: "Войдите в систему, чтобы сохранить план.",
      save_error_generic: "Что-то пошло не так. Попробуйте еще раз.",
      edit_title: "Редактировать план",
      preserve_progress: "Ваш прогресс ({sessions} сессий) будет сохранен.",
      my_plan_title: "Мой тренировочный план",
      progress_title: "Прогресс",
      progress_sessions: "Завершено сессий: {count}",
      next_recommended: "Рекомендуется следующий: день {day} · цикл {cycle}",
      weekly_split_title: "Недельный сплит",
      days_per_week: "{days} дней / неделю",
      next_up: "Следующий",
      save_plan: "Сохранить план",
      save_changes: "Сохранить изменения",
      train_button: "Тренироваться",
    },
  quick: {
    title: "Быстрая тренировка",
    subtitle: "Небольшой безинвентарный цикл, избегающий мышц из дневного плана",
    time_label: "Сколько времени у вас есть?",
    hint: "Подходит для перерыва во время работы или в выходной.",
    generate: "Сгенерировать быструю тренировку",
    generate_with_duration: "Сгенерировать быструю тренировку ({duration} мин)",
    generating: "Генерация...",
    time_option_label: "{minutes} мин",
  },
 plan_session: {
      title: "Быстрое плановое занятие",
      subtitle: "За один клик соберите полную тренировку на сегодня и продвиньте план",
      today_title: "Сегодня: День {day}",
      reason_no_recent_training: "Недавних тренировок не найдено. Начинаем с дня 1.",
      reason_cycle_reset: "Круг завершён. Следующий цикл начинается с дня {day} (последняя сессия была {restDays} дн. назад).",
      reason_continue: "Последняя сессия была в день {lastDay} ({restDays} дн. назад). Продолжайте с дня {nextDay}.",
      target_duration: "Целевая продолжительность: {duration} мин",
      duration_badge: "Рекомендуемая продолжительность: {duration} мин",
      duration_range: "Рекомендуемый диапазон: {min}-{max} мин",
      hint: "Выберите снаряд(ы) ниже и сразу начните.",
      generate: "Начать тренировку сегодня",
      generate_with_duration: "Начать тренировку сегодня ({duration} мин)",
      start_today_with_duration: "Начать тренировку сегодня ({duration} мин)",
      configure_equipment: "Сначала выберите оборудование",
      requires_equipment: "Выберите минимум одно оборудование (или включите режим только с весом тела) перед запуском.",
      manage_plan: "Управление планом и прогрессом",
      generating: "Генерация...",
    },
    stepper_bodyweight_mode_notice: "Режим только с весом тела активен. Для вас автоматически используется BODY_ONLY; измените это в предпочтениях.",
    stepper_bodyweight_preference_notice: "Предпочтение чисто собственный вес включено, BODY_ONLY используется по умолчанию.",
    stepper_split_day_hint: "Мышцы дня {day} загружены из вашего сплита. При необходимости поправьте.",
    steps: {
      equipment: {
        title: "Оборудование",
    ...
    exercise: {
      ...
      image_alt: "Изображение упражнения",
      description_title: "Описание",
      equipment_title: "Оборудование",
      types_title: "Типы упражнения",
      shuffle: "Перемешать",
      pick: "Выбрать",
      remove: "Удалить",
      cancel: "Отмена",
      confirm_pick: "Подтвердить выбор",
    ...
    add_with_name: "Добавить {name}",
    exerciseAdded: "{name} добавлено в тренировку",
    add_exercise_mascot_alt: "Маскот тренировки",
    ...
    session: {
     ...
     finish_session: "Завершить сессию",
      rest_label: "Отдых",
      rest_countdown: "{seconds} сек",
      skip_rest: "Пропустить отдых",
      error_delete_session: "Не удалось удалить сессию. Повторите попытку.",
      error_shuffling_exercise: "Не удалось перемешать упражнение. Повторите попытку.",
      error_picking_exercise: "Не удалось выбрать упражнение. Повторите попытку.",
      ...
      prescription_card_title: "Настройки сессии",
      prescription_rest_label: "Интервал отдыха",
      prescription_rest_value: "{seconds} сек",
      prescription_warmup_label: "Разминка",
      prescription_warmup_value: "{sets} x {reps} повторений",
      prescription_cooldown_label: "Заминка",
      prescription_cooldown_value: "{sets} x {seconds} сек удержание",
      prescription_feature_disabled: "Не включено",
      stretch_reps: "повт. на сторону",
      stretch_hold: "секунд на сторону",
      exercise_completed: "Упражнение завершено",
      exercise_pending: "Ожидающее упражнение",
      toggle_complete: "Переключить завершение",
     ...
     bodyweight: "Собственный вес",
      ...
      started_at: "Начато в",
      target_duration_label: "Рекомендуемая длительность",
      remaining_time: "Осталось: {time}",
      target_time_exceeded: "Превышение на {time}",
      ...
      exercise_image_alt: "Изображение упражнения",

export default {
 ...
 workout_builder: {
  ...
  goal_select: "Objectif d'entraînement",
  goal_strength: "Force",
  goal_hypertrophy: "Hypertrophie",
  goal_endurance: "Endurance",
  goal_general: "Condition générale",
  days_select: "Jours par semaine",
  split_preview: "Votre split hebdomadaire",
  split_hint: "Les chiffres indiquent les séries ciblées par muscle. x2 signifie entraîné deux fois par semaine.",
  split_fullbody_1: "Corps entier A",
  split_fullbody_2: "Corps entier B",
  split_ppl_1: "Push",
  split_ppl_2: "Pull",
  split_ppl_3: "Jambes",
  split_upperlower_1: "Haut A",
  split_upperlower_2: "Bas A",
  split_upperlower_3: "Haut B",
  split_upperlower_4: "Bas B",
  "split_ppl-ul_1": "Push",
  "split_ppl-ul_2": "Pull",
  "split_ppl-ul_3": "Jambes",
  "split_ppl-ul_4": "Haut",
  "split_ppl-ul_5": "Bas + Core",
  split_upper: "Haut",
  split_lower_core: "Bas + Core",
  goal_split: {
    selection_hint: "Touchez un jour pour charger ses muscles. Vous pourrez les ajuster à l'étape suivante.",
  },
  plan_page: {
    create_title: "Créer votre plan d'entraînement",
    create_subtitle: "Définissez votre objectif et votre fréquence. Nous générerons un split basé sur la science.",
    sign_in_prompt_suffix: "pour enregistrer votre plan et suivre vos progrès.",
    save_error_auth: "Veuillez vous connecter pour enregistrer votre plan.",
    save_error_generic: "Une erreur s'est produite. Veuillez réessayer.",
    edit_title: "Modifier votre plan",
    preserve_progress: "Vos {sessions} séances terminées seront conservées.",
    my_plan_title: "Mon plan d'entraînement",
    progress_title: "Progrès",
    progress_sessions: "{count} séances terminées",
    next_recommended: "Prochaine recommandation : Jour {day} · Cycle {cycle}",
    weekly_split_title: "Split hebdomadaire",
    days_per_week: "{days} jours / semaine",
    next_up: "À faire ensuite",
    save_plan: "Enregistrer le plan",
    save_changes: "Enregistrer les modifications",
    train_button: "S'entraîner",
  },
  quick: {
    title: "Séance rapide",
    ...
    generate_with_duration: "Générer la séance rapide ({duration} min)",
  ...
  plan_session: {
    ...
    today_title: "Aujourd'hui : Jour {day}",
    reason_no_recent_training: "Aucun historique récent. Commencez au jour 1.",
    reason_cycle_reset: "Cycle terminé. Démarrez le cycle suivant au jour {day} ({restDays} j depuis la dernière session).",
    reason_continue: "Dernière séance : jour {lastDay} (il y a {restDays} j). Passez au jour {nextDay}.",
    target_duration: "Durée cible : {duration} min",
    duration_badge: "Durée suggérée : {duration} min",
    duration_range: "Fourchette suggérée : {min}-{max} min",
    hint: "Sélectionnez votre équipement ci-dessous, puis générez instantanément.",
    generate: "Démarrer l'entraînement du jour",
    generate_with_duration: "Démarrer l'entraînement du jour ({duration} min)",
    start_today_with_duration: "Démarrer l'entraînement du jour ({duration} min)",
    configure_equipment: "Choisissez d'abord l'équipement",
    requires_equipment: "Sélectionnez au moins un équipement (ou activez le mode poids du corps) avant de générer.",
    manage_plan: "Gérer le plan et la progression",
    generating: "Génération...",
  },
  stepper_bodyweight_mode_notice: "Le mode poids du corps est actif. L'équipement BODY_ONLY est appliqué automatiquement; modifiez-le dans vos préférences si nécessaire.",
  stepper_bodyweight_preference_notice: "La préférence poids du corps est active et BODY_ONLY est pré-sélectionné.",
  stepper_split_day_hint: "Les muscles du jour {day} ont été chargés depuis votre programme. Ajustez si nécessaire.",
    steps: {
      equipment: {
        title: "Équipement",
    ...
    exercise: {
      ...
      image_alt: "Image de l'exercice",
      description_title: "Description",
      equipment_title: "Équipement",
      types_title: "Types d'exercice",
      shuffle: "Mélanger",
      pick: "Choisir",
      remove: "Supprimer",
      cancel: "Annuler",
      confirm_pick: "Confirmer la sélection",
    ...
    add_exercise_mascot_alt: "Mascotte d'entraînement",
    exercises: "exercices",
    equipment: {
      bodyweight: {
    ...
    session: {
     ...
     finish_session: "Terminer la séance",
      ...
      error_delete_session: "Erreur lors de la suppression de la séance. Veuillez réessayer.",
      error_shuffling_exercise: "Erreur lors du mélange de l'exercice. Veuillez réessayer.",
      error_picking_exercise: "Erreur lors de la sélection de l'exercice. Veuillez réessayer.",
      ...
      prescription_card_title: "Paramètres de la séance",
      prescription_rest_label: "Intervalle de repos",
      prescription_rest_value: "{seconds}s",
      prescription_warmup_label: "Échauffement",
      prescription_warmup_value: "{sets} x {reps} répétitions",
      prescription_cooldown_label: "Retour au calme",
      prescription_cooldown_value: "{sets} x {seconds}s maintien",
      prescription_feature_disabled: "Non inclus",
      stretch_reps: "rép. par côté",
      stretch_hold: "secondes par côté",
      exercise_completed: "Exercice terminé",
      exercise_pending: "Exercice à venir",
      toggle_complete: "Marquer terminé",
      delete_set: "Supprimer la série",
      time_unit_min: "min",
      time_unit_seconds: "s",
     bodyweight: "Poids du corps",
      ...
      started_at: "Débuté à",
      target_duration_label: "Durée recommandée",
      remaining_time: "Restant : {time}",
      target_time_exceeded: "Dépassement de {time}",
      ...
      exercise_image_alt: "Image de l'exercice",

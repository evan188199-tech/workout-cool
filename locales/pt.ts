...
export default {
 ...
 workout_builder: {
  ...
  goal_select: "Objetivo do treino",
  goal_strength: "Força",
  goal_hypertrophy: "Hipertrofia",
  goal_endurance: "Resistência",
  goal_general: "Geral",
  days_select: "Dias por semana",
  split_preview: "A sua divisão semanal",
  split_hint: "Os números mostram as séries-alvo por músculo. x2 significa treinado duas vezes por semana.",
  split_fullbody_1: "Corpo inteiro A",
  split_fullbody_2: "Corpo inteiro B",
  split_ppl_1: "Empurrar",
  split_ppl_2: "Puxar",
  split_ppl_3: "Pernas",
  split_upperlower_1: "Superior A",
  split_upperlower_2: "Inferior A",
  split_upperlower_3: "Superior B",
  split_upperlower_4: "Inferior B",
  "split_ppl-ul_1": "Empurrar",
  "split_ppl-ul_2": "Puxar",
  "split_ppl-ul_3": "Pernas",
  "split_ppl-ul_4": "Superior",
  "split_ppl-ul_5": "Inferior + Core",
  split_upper: "Superior",
  split_lower_core: "Inferior + Core",
  goal_split: {
    selection_hint: "Toque num dia para carregar os músculos. Pode ajustá-los na etapa seguinte.",
  },
  plan_page: {
    create_title: "Criar o seu plano de treino",
    create_subtitle: "Defina o objetivo e a agenda. Geraremos uma divisão com base na ciência.",
    sign_in_prompt_suffix: "para guardar o seu plano e acompanhar o progresso.",
    save_error_auth: "Faça login para guardar o seu plano.",
    save_error_generic: "Algo correu mal. Tente novamente.",
    edit_title: "Editar o seu plano",
    preserve_progress: "O seu progresso ({sessions} sessões) será preservado.",
    my_plan_title: "O meu plano de treino",
    progress_title: "Progresso",
    progress_sessions: "{count} sessões concluídas",
    next_recommended: "Próximo recomendado: Dia {day} · Ciclo {cycle}",
    weekly_split_title: "Divisão semanal",
    days_per_week: "{days} dias / semana",
    next_up: "A seguir",
    save_plan: "Guardar plano",
    save_changes: "Guardar alterações",
    train_button: "Treinar",
  },
    quick: {
      title: "Treino rápido",
      subtitle: "Um circuito leve de peso corporal que evita os músculos de hoje",
    time_label: "Quanto tempo tem disponível?",
    hint: "Ideal para pausa ativa no trabalho ou em dias de descanso.",
    generate: "Gerar treino rápido",
    generate_with_duration: "Gerar treino rápido ({duration} min)",
    generating: "Gerando...",
    time_option_label: "{minutes} min",
  },
    plan_session: {
    title: "Sessão de plano rápido",
    subtitle: "Gera o treino completo de hoje com um clique e avança o plano",
    today_title: "Hoje: Dia {day}",
    reason_no_recent_training: "Sem histórico recente de treino. Começa pelo Dia 1.",
    reason_cycle_reset: "Ciclo concluído. Inicie o próximo ciclo no Dia {day} ({restDays} dias desde a última sessão).",
    reason_continue: "Última sessão foi no Dia {lastDay} ({restDays} dias atrás). Continue no Dia {nextDay}.",
    target_duration: "Duração alvo: {duration} min",
    duration_badge: "Duração sugerida: {duration} min",
    duration_range: "Faixa sugerida: {min}-{max} min",
    hint: "Selecione o equipamento abaixo e gere na hora.",
      generate: "Iniciar treino de hoje",
      generate_with_duration: "Iniciar treino de hoje ({duration} min)",
      start_today_with_duration: "Iniciar treino de hoje ({duration} min)",
      configure_equipment: "Selecione o equipamento primeiro",
      requires_equipment: "Selecione pelo menos um equipamento (ou ative o modo apenas com peso corporal) antes de gerar.",
      manage_plan: "Gerir plano e progresso",
      generating: "Gerando...",
    },
    stepper_bodyweight_mode_notice: "Modo de peso corporal está ativo. O equipamento BODY_ONLY é aplicado automaticamente; ajuste em preferências se necessário.",
    stepper_bodyweight_preference_notice: "A preferência de peso corporal está ativa e o BODY_ONLY é aplicado por defeito.",
    stepper_split_day_hint: "Músculos do dia {day} carregados do seu split. Ajuste se necessário.",
    steps: {
      equipment: {
        title: "Equipamento",
    ...
    exercise: {
      ...
      image_alt: "Imagem do exercício",
      description_title: "Descrição",
      equipment_title: "Equipamento",
      types_title: "Tipos de exercício",
      shuffle: "Aleatorizar",
      pick: "Escolher",
      remove: "Remover",
      cancel: "Cancelar",
      confirm_pick: "Confirmar seleção",
    ...
    add_with_name: "Adicionar {name}",
    exerciseAdded: "{name} adicionado ao treino",
    add_exercise_mascot_alt: "Mascote de treino",
    exercises: "exercícios",
    equipment: {
      bodyweight: {
        label: "Peso corporal",
    ...
    session: {
     ...
     finish_session: "Terminar sessão",
      ...
      error_delete_session: "Falha ao eliminar a sessão de treino. Tente novamente.",
      error_shuffling_exercise: "Falha ao trocar o exercício. Tente novamente.",
      error_picking_exercise: "Falha ao selecionar o exercício. Tente novamente.",
      ...
      prescription_card_title: "Configurações da sessão",
      prescription_rest_label: "Intervalo de descanso",
      prescription_rest_value: "{seconds}s",
      prescription_warmup_label: "Aquecimento",
      prescription_warmup_value: "{sets} x {reps} repetições",
      prescription_cooldown_label: "Desaquecimento",
      prescription_cooldown_value: "{sets} x {seconds}s de manutenção",
      prescription_feature_disabled: "Não incluído",
      stretch_reps: "rep. por lado",
      stretch_hold: "segundos por lado",
      exercise_completed: "Exercício concluído",
      exercise_pending: "Exercício seguinte",
      toggle_complete: "Marcar como concluído",
      delete_set: "Excluir série",
      time_unit_min: "min",
      time_unit_seconds: "s",
     bodyweight: "Peso corporal",
      ...
      target_duration_label: "Duração recomendada",
      remaining_time: "Restante: {time}",
      target_time_exceeded: "Ultrapassado em {time}",
      ...
      exercise_image_alt: "Imagem do exercício",
